    ...
    public class SampleTrack
    {
        public static List<SampleTrack> Tracks =
            new List<SampleTrack>
            {
                ...
                new SampleTrack("JavaScript", "JVS", "JavaScript", "jQuery", "Knockout", "JsRender", "MVVM", "HTML5",
                    "SPA", "Amplify", "Underscore", "Backbone", "Web"),
                ...
                new SampleTrack("Mobile", "MOB", "Mobile", "WP7", "PhoneGap", "Android", "iPad", "iOS", "Xamarin",
                    "Kinect", "XNA", "Web"),
                new SampleTrack("Cloud", "CLD", "Cloud", "Node", "Azure", "Amazon", "EC2", "Service Bus", "SkyDrive",
                    "Web"),
                new SampleTrack("Practices", "PRC", "Practices", "TFS", "Agility", "TDD", "Testing", "Mocks", "Scrum",
                    "Lean", "Web"),
        ...
        {
            get { return Tracks.Select(t => t.Name).ToList(); }
        }

        public static List<string> CodeRoots
        {
            get { return Tracks.Select(t => t.CodeRoot).ToList(); }
        }
